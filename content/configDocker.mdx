...
Este guia irá ensinar como instalar o Docker, Docker Compose e dar as permissões 
...
4.  Use o comando abaixo para instalar a versão mais estável do Docker:
    ...
    para mais informações consulte o link [Docker User](https://docs.docker.com/install/linux/linux-postinstall/).
